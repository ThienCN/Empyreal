        ...
        public void ExportToExcel()
        {
            ...
            try
            {
                using (ExcelPackage package = new ExcelPackage())
                {
                    ...
                    worksheet.Cells[8, 4].Value = string.Format("Thống kê trong tháng {0}/{1}", month, year);
