...
{
    public class ProfileViewModel : ManagerBaseViewModel
    {
        ...
        [Required(ErrorMessage = "Vui lòng nhập email"), MaxLength(256, ErrorMessage = "Email tối đa 100 ký tự")]
        ...
        [RequiredIf("IsChangePass == true", ErrorMessage = "Vui lòng nhập mật khẩu hiện tại"), DataType(DataType.Password)]
        public string CurrentPassword { get; set; }

        [RequiredIf("IsChangePass == true", ErrorMessage = "Mật khẩu phải có ít nhất 6 ký tự"), DataType(DataType.Password)]
        public string NewPassword { get; set; }

        [DataType(DataType.Password), Compare(nameof(NewPassword), ErrorMessage = "Mật khẩu xác nhận không khớp")]
