...
function panel_refresh(panel,action,callback){        
    if(!panel.hasClass("panel-refreshing")){
        panel.append('<div class="panel-refresh-layer"><img src="/images/default.gif"/></div>');
...
function x_navigation_minimize(action){
    ...
    if(action == 'open'){
        $(".page-container").removeClass("page-container-wide");
        $(".page-sidebar .x-navigation").removeClass("x-navigation-minimized");
        $(".x-navigation-minimize").find(".fas").removeClass("fa-indent").addClass("fa-outdent");
    ...
    if(action == 'close'){
        ...
        $(".x-navigation-minimize").find(".fas").removeClass("fa-outdent").addClass("fa-indent");
...
function x_navigation(){
    ...
    //$(".page-sidebar .x-navigation").hover(function () {
